    ...
    <div class="content">
        ...
        <div class="contact-bloc">
            <div class="info-contact">
                ...
                <a href="mailto:contact@alexandra-connangle.net">contact@alexandra-connangle.net</a><br/>
                <a href="https://github.com/AlexandraConnangle" target="_blank">https://github.com/AlexandraConnangle</a>
            </div>
        </div>

        <div class="presentation-bloc">
            <div class="profil-bloc">
                <div class="profil-icon"> <i class="fas fa-user-graduate"></i> </div>
            ...
            <div class="job-bloc">
                <div class="job-icone"> <i class="fas fa-briefcase"></i> </div>
                <div class="job-text">
